...
size_t square_points_poisson(tkernel<glm::tvec2<T, P>> & kernel, const unsigned int num_probes)
{
...
template <typename T, glm::precision P>
size_t square_points_poisson_ext(tkernel<glm::tvec2<T, P>> & kernel, const unsigned int num_probes)
{
    assert(kernel.depth() == 1);
...
template <typename T, glm::precision P>
size_t square_points_poisson_ext(tkernel<glm::tvec2<T, P>> & kernel, const T min_dist, const unsigned int num_probes)
{
    assert(kernel.depth() == 1);
