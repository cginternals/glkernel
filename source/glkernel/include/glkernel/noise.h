...
public:
    ...
    static void normal(tkernel<T> & kernel, const T mean, const T stddev);

    // ToDo: somehow unify the following forward declarations with:
    //template <typename T, glm::precision P, template<typename, glm::precision> class V>
    //static void normal(tkernel<glm::tvec2<T, P>> & kernel, const T mean, const T stddev);

    template <typename T, glm::precision P>
    static void normal(tkernel<glm::tvec2<T, P>> & kernel, const T mean, const T stddev);
    template <typename T, glm::precision P>
    static void normal(tkernel<glm::tvec3<T, P>> & kernel, const T mean, const T stddev);
    template <typename T, glm::precision P>
    static void normal(tkernel<glm::tvec4<T, P>> & kernel, const T mean, const T stddev);
    ...
    template<typename T, typename std::enable_if<std::is_floating_point<T>::value, int>::type = 0>
    static void uniform(tkernel<T> & kernel, const T range_min, const T range_max);
    ...
    template <typename T, glm::precision P>
    static void uniform(tkernel<glm::tvec2<T, P>> & kernel, const T range_min, const T range_max);
    template <typename T, glm::precision P>
    static void uniform(tkernel<glm::tvec3<T, P>> & kernel, const T range_min, const T range_max);
    template <typename T, glm::precision P>
    static void uniform(tkernel<glm::tvec4<T, P>> & kernel, const T range_min, const T range_max);
