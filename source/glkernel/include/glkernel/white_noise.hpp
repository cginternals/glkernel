...
void white_noise(Kernel<glm::tvec2<T, P>> & kernel, const T range_min, const T range_max)
{
    std::random_device RD;
    std::mt19937_64 generator(RD());
...
template <typename T, glm::precision P>
void white_noise(Kernel<glm::tvec3<T, P>> & kernel, const T range_min, const T range_max)
{
    std::random_device RD;
    std::mt19937_64 generator(RD());
...
template <typename T, glm::precision P>
void white_noise(Kernel<glm::tvec4<T, P>> & kernel, const T range_min, const T range_max)
{
    std::random_device RD;
    std::mt19937_64 generator(RD());
...
template <typename T, glm::precision P>
void white_noise(Kernel<glm::tvec2<T, P>> & kernel, const glm::tvec2<T, P> & range_min, const glm::tvec2<T, P> & range_max)
{
    std::random_device RD;
    std::mt19937_64 generator(RD());
...
template <typename T, glm::precision P>
void white_noise(Kernel<glm::tvec3<T, P>> & kernel, const glm::tvec3<T, P> & range_min, const glm::tvec3<T, P> & range_max)
{
    std::random_device RD;
    std::mt19937_64 generator(RD());
...
template <typename T, glm::precision P>
void white_noise(Kernel<glm::tvec4<T, P>> & kernel, const glm::tvec4<T, P> & range_min, const glm::tvec4<T, P> & range_max)
{
    std::random_device RD;
    std::mt19937_64 generator(RD());
